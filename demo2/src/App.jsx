...
function App() {
  ...
  return (
    <div className="min-h-screen bg-obsidian-950 text-white font-sans flex flex-col justify-between selection:bg-gold selection:text-black">
      
      {/* Top Navbar */}
      <header className="sticky top-0 z-50 bg-obsidian-950/95 backdrop-blur-md border-b border-gold/15 py-4">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => setActivePage('home')}>
            ...
            <div>
              <h1 className="font-serif text-xl tracking-widest font-bold">CINE<span className="text-gold">.</span></h1>
            ...
            {['home', 'about', 'portfolio', 'services', 'contact'].map((tab) => (
              <button
                ...
                className={`px-4 py-2 text-xs font-semibold uppercase tracking-widest rounded-sm border transition-all ${
                  activePage === tab 
                    ? 'text-gold border-gold bg-gold/5 shadow-[0_0_10px_rgba(212,175,55,0.25)]' 
          ...
          <div className="relative group md:hidden">
            ...
            <div className="absolute right-0 top-full mt-1 w-44 bg-obsidian-900 border border-gold/15 rounded-sm shadow-xl hidden group-hover:flex flex-col py-1.5 z-50">
              {['home', 'about', 'portfolio', 'services', 'contact'].map((tab) => (
                <button
                  key={tab}
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 flex-grow w-full">
        ...
        {activePage === 'home' && (
          <div className="space-y-16 animate-[fadeIn_0.45s_ease-out]">
            {/* Hero Banner */}
            <div className="relative h-[65vh] bg-black overflow-hidden border border-gold/10 shadow-2xl flex items-center">
              ...
              <img 
                ...
                className="absolute inset-0 w-full height-full object-cover opacity-25" 
              />
              <div className="absolute inset-0 bg-radial-dark z-0 bg-gradient-to-t from-obsidian-950 via-transparent to-transparent"></div>
              ...
              <div className="relative z-20 px-6 md:px-12 max-w-2xl">
                ...
                <h1 className="text-3xl md:text-5xl font-serif tracking-widest text-white leading-none mb-6">Stories Written In Light.</h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="bg-gold text-black text-xs font-bold uppercase tracking-widest px-6 py-3 hover:bg-white transition-all" onClick={() => setActivePage('portfolio')}>
                    Enter Showcase
                  </button>
                  <button className="bg-transparent border border-zinc-700 text-white text-xs font-bold uppercase tracking-widest px-6 py-3 hover:border-gold hover:text-gold transition-all" onClick={() => setActivePage('contact')}>
            ...
            {/* Philosophy Pitch */}
            <div className="bg-obsidian-900 border border-gold/10 p-10 flex flex-col md:flex-row items-center gap-8 justify-between">
              ...
              <div className="flex gap-8 border-t md:border-t-0 md:border-l border-gold/10 pt-6 md:pt-0 md:pl-10">
                <div>
            ...
            <div>
              ...
              <div className="bg-obsidian-800 border border-gold/15 grid grid-cols-1 md:grid-cols-12 min-h-[400px]">
                ...
                <div className="md:col-span-5 p-8 flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-2xl font-serif mb-4 leading-snug">{TEASER_STORIES[teaserIdx].title}</h3>
                    <p className="text-xs font-light text-zinc-400 leading-relaxed mb-6">{TEASER_STORIES[teaserIdx].desc}</p>
                    
                    <div className="grid grid-cols-3 gap-4 border-t border-gold/10 pt-4 mb-6">
                      <div>
                        <span className="text-[0.6rem] uppercase text-zinc-500 block">Client</span>
                        <span className="text-xs font-semibold text-zinc-200">{TEASER_STORIES[teaserIdx].stats.client}</span>
                      </div>
                      <div>
                        <span className="text-[0.6rem] uppercase text-zinc-500 block">Optics</span>
                        <span className="text-xs font-semibold text-zinc-200">{TEASER_STORIES[teaserIdx].stats.lens}</span>
                      </div>
                      <div>
                        <span className="text-[0.6rem] uppercase text-zinc-500 block">Body</span>
                        <span className="text-xs font-semibold text-zinc-200">{TEASER_STORIES[teaserIdx].stats.gear}</span>
                      </div>
                    </div>
                  </div>

                  <div className="flex gap-3">
                    <button className="bg-obsidian-950 border border-gold/15 text-white p-3 hover:border-gold hover:text-gold transition-all" onClick={handlePrevTeaser}>
                      <ChevronLeft size={16} />
                    </button>
                    <button className="bg-obsidian-950 border border-gold/15 text-white p-3 hover:border-gold hover:text-gold transition-all" onClick={handleNextTeaser}>
            ...
            {/* Why Cine Photography USP section */}
            <div>
              <h2 className="text-2xl font-serif tracking-widest text-center mb-8">What Sets Us Apart</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-obsidian-900 border border-gold/10 p-8 rounded-sm hover:border-gold/30 transition-all">
                  <div className="text-gold mb-4"><Users size={26} /></div>
                  <h4 className="font-serif text-sm font-semibold mb-2">Hospitality First</h4>
                ...
                <div className="bg-obsidian-900 border border-gold/10 p-8 rounded-sm hover:border-gold/30 transition-all">
                  ...
                  <h4 className="font-serif text-sm font-semibold mb-2">Impeccable Punctuality</h4>
                  <p className="text-xs font-light text-zinc-400 leading-relaxed">
                ...
                <div className="bg-obsidian-900 border border-gold/10 p-8 rounded-sm hover:border-gold/30 transition-all">
                  ...
                  <h4 className="font-serif text-sm font-semibold mb-2">Value & Transparency</h4>
                  <p className="text-xs font-light text-zinc-400 leading-relaxed">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                {['Wedding Cinema Award 2024', 'Low-Light Portraiture 2025', 'Destination Fine Art Gold', 'Stage Capture Excellence'].map((award, i) => (
                  <div key={i} className="bg-obsidian-800 border border-gold/10 p-6 flex flex-col justify-center items-center">
                    <span className="text-xs font-serif text-gold block mb-2">★ GOLD MEDAL ★</span>
                    <span className="text-xs font-semibold text-zinc-300 uppercase tracking-wider">{award}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="space-y-16 animate-[fadeIn_0.45s_ease-out]">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
              <div className="md:col-span-7">
                ...
                <h2 className="text-4xl font-serif leading-none mb-6">Born Behind The Lens</h2>
                ...
                <div className="border-l-2 border-gold pl-4 py-2 text-sm italic text-zinc-300 font-serif">
              ...
              <div className="md:col-span-5 flex justify-center">
                <div className="bg-obsidian-900 border border-gold/15 p-12 text-center relative max-w-[380px] w-full">
                  ...
                  <h3 className="font-serif text-lg text-white">CINE PHOTOGRAPHY</h3>
            ...
            <div>
              ...
              <div className="space-y-8 max-w-3xl border-l border-gold/15 ml-4 pl-8 py-4">
                <div className="relative">
                  <div className="absolute -left-[41px] top-1 w-4 h-4 rounded-full bg-gold border-4 border-obsidian-950"></div>
                  <span className="text-sm font-serif text-gold font-bold">2012</span>
                  <h4 className="text-sm font-semibold text-white mt-1">Loft Launch</h4>
                ...
                <div className="relative">
                  ...
                  <h4 className="text-sm font-semibold text-white mt-1">Cinematography Expansion</h4>
                  <p className="text-xs font-light text-zinc-400 leading-relaxed mt-1">
                ...
                <div className="relative">
                  ...
                  <h4 className="text-sm font-semibold text-white mt-1">Global Campaigns</h4>
                  <p className="text-xs font-light text-zinc-400 leading-relaxed mt-1">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-obsidian-900 border border-gold/10 rounded-sm overflow-hidden hover:border-gold/30 transition-all">
                  ...
                  <div className="p-6">
                    <span className="text-[0.65rem] font-bold text-gold uppercase tracking-wider">Co-Founder / Director</span>
                    <h3 className="font-serif text-md mt-1 mb-2">Christian Navas</h3>
                    <p className="text-xs font-light text-zinc-400 leading-relaxed">
                ...
                <div className="bg-obsidian-900 border border-gold/10 rounded-sm overflow-hidden hover:border-gold/30 transition-all">
                  ...
                  <div className="p-6">
                    <span className="text-[0.65rem] font-bold text-gold uppercase tracking-wider">Cinematography Lead</span>
                    <h3 className="font-serif text-md mt-1 mb-2">Logesh Christian</h3>
                    <p className="text-xs font-light text-zinc-400 leading-relaxed">
                ...
                <div className="bg-obsidian-900 border border-gold/10 rounded-sm overflow-hidden hover:border-gold/30 transition-all">
                  ...
                  <div className="p-6">
                    <span className="text-[0.65rem] font-bold text-gold uppercase tracking-wider">Art Director</span>
                    <h3 className="font-serif text-md mt-1 mb-2">Sarah Vance</h3>
                    <p className="text-xs font-light text-zinc-400 leading-relaxed">
            ...
            {/* Technical Rig Spotlight */}
            <div>
              <h2 className="text-2xl font-serif tracking-widest mb-6">Technical Equipment</h2>
              <div className="overflow-x-auto border border-gold/10 bg-obsidian-900">
                <table className="min-w-full text-xs text-left">
                  <thead className="bg-obsidian-800 text-gold uppercase font-serif border-b border-gold/10">
                    <tr>
                  ...
                  <tbody className="divide-y divide-gold/5 font-light text-zinc-300">
                    <tr>
                      <td className="px-6 py-4 font-semibold text-white">Camera Systems</td>
                    ...
                    <tr>
                      <td className="px-6 py-4 font-semibold text-white">Optics</td>
                    ...
                    <tr>
                      <td className="px-6 py-4 font-semibold text-white">Stabilizers</td>
        ...
        {activePage === 'portfolio' && (
          <div className="space-y-8 animate-[fadeIn_0.45s_ease-out]">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-serif text-white">The Production Dashboard</h2>
            </div>

            {/* Dashboard Control Panel */}
            <div className="bg-obsidian-900 border border-gold/10 p-6 rounded-sm grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
              {/* Search */}
              <div className="lg:col-span-3 relative">
                ...
                <input 
                  ...
                  className="w-full bg-obsidian-950 border border-gold/10 text-white pl-10 pr-4 py-2 text-xs rounded-sm outline-none focus:border-gold transition-all"
                  value={searchQuery}
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-[0.65rem] font-bold uppercase tracking-wider rounded-sm border transition-all ${
                      categoryFilter === cat 
                        ...
                        : 'text-zinc-400 border-gold/10 bg-obsidian-950 hover:text-white hover:border-zinc-700'
                    }`}
              ...
              {/* Type Switcher */}
              <div className="lg:col-span-3 flex justify-center lg:justify-end border border-gold/10 rounded-sm overflow-hidden bg-obsidian-950">
            ...
            {paginatedMedia.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                {paginatedMedia.map((item) => (
                  <div 
                    key={item.id} 
                    className={`bg-obsidian-900 border border-gold/10 rounded-sm overflow-hidden hover:border-gold transition-all cursor-pointer ${
                  ...
                  >
                    <div className="relative aspect-video overflow-hidden bg-black">
                      ...
                      {item.type === 'video' && (
                        <div className="absolute inset-0 flex items-center justify-center bg-black/35">
                          <div className="w-12 h-12 rounded-full bg-obsidian-950/90 border border-gold text-gold flex items-center justify-center hover:bg-gold hover:text-black transition-all">
                    ...
                    <div className="p-4 flex justify-between items-center">
                      <h4 className="font-serif text-xs text-white">{item.title}</h4>
              ...
              <div className="text-center py-16 border border-dashed border-gold/10 text-zinc-500 text-xs">
            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center gap-3">
                <button 
                  className="w-10 h-10 bg-obsidian-900 border border-gold/15 flex items-center justify-center hover:border-gold disabled:opacity-20 transition-all"
                  ...
                  <button
                    ...
                    className={`w-10 h-10 border flex items-center justify-center text-xs font-bold transition-all ${
                      currentPage === i + 1 
                        ...
                        : 'bg-obsidian-900 border-gold/15 text-zinc-400 hover:border-gold hover:text-white'
                    }`}
        ...
        {activePage === 'services' && (
          <div className="space-y-8 animate-[fadeIn_0.45s_ease-out]">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-serif text-white">Capabilities & Packages</h2>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  <button
                    ...
                    className={`p-5 text-left border rounded-sm transition-all ${
                      activeServiceTab === s.id 
                        ? 'bg-gold/5 border-gold text-gold font-semibold shadow-[0_0_8px_rgba(212,175,55,0.15)]' 
                        : 'bg-obsidian-900 border-gold/10 text-zinc-400 hover:border-gold/30 hover:text-white'
                    }`}
              ...
              {(() => {
                ...
                return (
                  <div className="lg:col-span-8 bg-obsidian-900 border border-gold/15 p-8 rounded-sm animate-[fadeIn_0.35s_ease-out]">
                    <div className="flex justify-between items-start border-b border-gold/10 pb-6 mb-6">
                      <div>
                        <h3 className="text-2xl font-serif text-white">{s.title}</h3>
                    ...
                    <p className="text-sm font-light text-zinc-300 leading-relaxed mb-6">{s.desc}</p>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-gold/10 pt-6 mb-8">
                      {/* Deliverables */}
                      <div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <span className="text-xs text-zinc-300 font-light leading-relaxed block mt-1">{s.gear}</span>
                        </div>
                        <div>
                          <span className="text-[0.6rem] uppercase text-zinc-500 block font-bold">Estimated Session Timeline</span>
                          <span className="text-xs text-zinc-300 font-light leading-relaxed block mt-1">{s.timeline}</span>
                        </div>
                      </div>
                    </div>

                    <button 
                      className="w-full bg-gold text-black text-xs font-bold uppercase tracking-widest py-3 hover:bg-white transition-all"
        ...
        {activePage === 'contact' && (
          <div className="space-y-16 animate-[fadeIn_0.45s_ease-out]">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
              ...
              <div className="lg:col-span-5 space-y-8">
                <div>
                  ...
                  <h2 className="text-3xl font-serif text-white">The Cine Lounge</h2>
                  <p className="text-xs font-light text-zinc-400 leading-relaxed mt-2">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="font-serif text-md text-white">12 Cinema Boulevard</p>
                    <p className="text-xs text-zinc-400">Suite 104, Portland, OR 97201</p>
                  </div>
                  <div>
                    <h4 className="text-[0.65rem] uppercase tracking-wider text-gold font-bold mb-1">Crew Hotlines</h4>
                    <p className="font-serif text-md text-white">hello@cinephotography.com</p>
                    <p className="text-xs text-zinc-400">Studio Phone: +1 (503) 555-0198</p>
                  </div>
                  <div>
                    <h4 className="text-[0.65rem] uppercase tracking-wider text-gold font-bold mb-1">Lounge Hours</h4>
                    <p className="font-serif text-md text-white">Tue - Sat / 10 AM - 7 PM</p>
                    <p className="text-xs text-zinc-400">Sundays by exclusive calendar slot reservation only.</p>
                  </div>
                </div>
              </div>

              {/* Interactive Scheduler Form */}
              <div className="lg:col-span-7 bg-obsidian-900 border border-gold/15 p-8 rounded-sm">
                {!bookingDone ? (
                  <form onSubmit={handleFormSubmit} className="space-y-5">
                    <h3 className="text-xl font-serif border-b border-gold/10 pb-3 mb-6">Schedule Consultation</h3>
                    
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex flex-col gap-2">
                        <label className="text-[0.65rem] uppercase tracking-wider text-gold font-bold" htmlFor="name">Your Name</label>
                        <input 
                          type="text" 
                          id="name"
                          className="bg-obsidian-950 border border-gold/10 text-white p-2.5 text-xs rounded-sm outline-none focus:border-gold transition-all"
                      ...
                      <div className="flex flex-col gap-2">
                        <label className="text-[0.65rem] uppercase tracking-wider text-gold font-bold" htmlFor="phone">Phone Number</label>
                        <input 
                          type="tel" 
                          id="phone"
                          className="bg-obsidian-950 border border-gold/10 text-white p-2.5 text-xs rounded-sm outline-none focus:border-gold transition-all"
                    ...
                    <div className="flex flex-col gap-2">
                      <label className="text-[0.65rem] uppercase tracking-wider text-gold font-bold" htmlFor="email">Email Address</label>
                      <input 
                        type="email" 
                        id="email"
                        className="bg-obsidian-950 border border-gold/10 text-white p-2.5 text-xs rounded-sm outline-none focus:border-gold transition-all"
                    ...
                    {/* Date Picker Grid */}
                    <div className="flex flex-col gap-2">
                      <label className="text-[0.65rem] uppercase tracking-wider text-gold font-bold">Select Briefing Date (July 2026)</label>
                      <div className="grid grid-cols-7 gap-1.5 mt-2">
                        {['M', 'T', 'W', 'T', 'F', 'S', 'S'].map((day, i) => (
                          <span key={i} className="text-center text-[0.65rem] font-bold text-zinc-500 uppercase">{day}</span>
                        ))}
                        {MOCK_CAL_DAYS.map((dayItem, idx) => (
                          <button
                            key={idx}
                            type="button"
                            className={`aspect-square bg-obsidian-950 border text-xs font-serif font-bold rounded-sm transition-all flex items-center justify-center ${
                              dayItem.disabled ? 'opacity-20 cursor-not-allowed border-transparent' : 
                              calDayIdx === idx ? 'bg-gold text-black border-gold' : 'border-gold/10 text-zinc-300 hover:border-gold'
                            }`}
                    ...
                    {/* Slot selector */}
                    <div className="flex flex-col gap-2">
                      <label className="text-[0.65rem] uppercase tracking-wider text-gold font-bold">Available Briefing Hours</label>
                          ...
                          <button
                            ...
                            className={`p-2.5 text-center text-xs border rounded-sm transition-all ${
                              calTimeIdx === idx 
                                ...
                                : 'bg-obsidian-950 border-gold/10 text-zinc-300 hover:border-gold'
                            }`}
                    ...
                    {/* Service pre-select drop-down */}
                    <div className="flex flex-col gap-2">
                      <label className="text-[0.65rem] uppercase tracking-wider text-gold font-bold" htmlFor="service-type">Inquiry Target Focus</label>
                      <select 
                        id="service-type"
                        className="bg-obsidian-950 border border-gold/10 text-white p-2.5 text-xs rounded-sm outline-none focus:border-gold transition-all"
                    ...
                    <button type="submit" className="w-full bg-gold text-black text-xs font-bold uppercase tracking-widest py-3.5 mt-4 hover:bg-white transition-all">
                  ...
                  <div className="text-center py-10 space-y-6">
                    ...
                    <h3 className="text-2xl font-serif text-white">Consultation Reserved</h3>
                    
                    {/* Mock print invoice summary */}
                    <div className="bg-obsidian-950 border border-gold/10 p-6 text-left max-w-md mx-auto text-xs space-y-3 font-light text-zinc-300">
                      <div className="border-b border-gold/10 pb-2 text-center text-gold font-serif uppercase tracking-widest font-semibold">
                        Cine Appointment Spec Summary
                      </div>
                      <div className="flex justify-between">
                        <span>Client Name:</span>
                        <span className="font-semibold text-white">{bookingForm.name}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Confirmed Slot:</span>
                        <span className="font-semibold text-white">July {MOCK_CAL_DAYS[calDayIdx].date}, 2026 @ {SCHEDULER_SLOTS[calTimeIdx].split(' ')[0]}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Inquiry Focus:</span>
                        <span className="font-semibold text-white">{bookingForm.service}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Communication:</span>
                        <span className="font-semibold text-white">{bookingForm.email}</span>
                      </div>
                    </div>
                    ...
                    <button className="btn-gold-outline inline-block" onClick={() => { setBookingDone(false); setBookingForm({ name: '', email: '', phone: '', service: 'Wedding Cinema & Candid', notes: '' }); }}>
                      Adjust Settings
                    </button>
                  </div>
                )}
            ...
            <div className="border-t border-gold/10 pt-12 max-w-3xl mx-auto">
              <h2 className="text-2xl font-serif tracking-widest text-center mb-8">Frequently Answered Questions</h2>
              <div className="space-y-4">
                {FAQ_DATA.map((faq, idx) => (
                  <div key={idx} className="bg-obsidian-900 border border-gold/10 rounded-sm">
                    <button
                      className="w-full p-5 text-left text-xs font-bold uppercase tracking-wider text-white flex justify-between items-center"
                    ...
                    {openFaqIdx === idx && (
                      <div className="p-5 pt-0 border-t border-gold/5 text-xs font-light text-zinc-400 leading-relaxed">
                        {faq.a}
                      </div>
                    )}
                  </div>
      ...
      <footer className="border-t border-gold/10 bg-obsidian-950 py-6 text-center text-[0.65rem] text-zinc-500 uppercase tracking-widest">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <span>© 2026 Cine Photography Studio. All rights reserved.</span>
          <span className="text-gold/50">Built for luxury cinematic rendering.</span>
        </div>
      </footer>
